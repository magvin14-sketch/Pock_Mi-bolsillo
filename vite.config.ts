  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        injectRegister: 'auto',
        includeAssets: ['favicon.png', 'apple-touch-icon.png', 'icon.svg', 'pwa-192x192.png', 'pwa-512x512.png', 'pwa-maskable-512x512.png', 'offline.html'],
        manifest: {
          id: '/',
          name: 'Pock - Organizador Financiero',
          short_name: 'Pock',
          description: 'Control de gastos, ingresos, deudas, metas de ahorro y corte de mes 100% offline.',
          theme_color: '#121316',
